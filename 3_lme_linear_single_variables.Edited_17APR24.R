...
#Points<-Points%>%
  #mutate(Peat_DepthL = log(Peat_Depth+1),
         #NDVI_Win = ((S2_Sum$B5-S2_Sum$B4)/(S2_Sum$B5+S2_Sum$B4)),
         #NDVI_Sum = ((S2_Win$B5-S2_Win$B4)/(S2_Win$B5+S2_Win$B4)))
...
DSM.model <- lme(fixed = Peat_Depth ~ Bodmin_DSM_clipped, data = Points, random = ~ 1 | dummy, method = "ML") 
slope.model <- lme(fixed = Peat_Depth ~ slope, data = Points, random = ~ 1 | dummy, method = "ML") 
aspect.model <- lme(fixed = Peat_Depth ~ aspect, data = Points, random = ~ 1 | dummy, method = "ML") 
SinAspect.model <- lme(fixed = Peat_Depth ~ SinAspect, data = Points, random = ~ 1 | dummy, method = "ML") 
CosAspect.model <- lme(fixed = Peat_Depth ~ CosAspect, data = Points, random = ~ 1 | dummy, method = "ML") 
roughness.model <- lme(fixed = Peat_Depth ~ roughness, data = Points, random = ~ 1 | dummy, method = "ML") 
TPI.model <- lme(fixed = Peat_Depth ~ TPI, data = Points, random = ~ 1 | dummy, method = "ML") 
TRI.model <- lme(fixed = Peat_Depth ~ TRI, data = Points, random = ~ 1 | dummy, method = "ML") 
TWI.model <- lme(fixed = Peat_Depth ~ Bodmin_TWI_Final, data = Points, random = ~ 1 | dummy, method = "ML") 
#VV_p95.model <- lme(fixed = Peat_Depth ~ VV_p95, data = Points, random = ~ 1 | dummy, method = "ML") 
#VV_p5.model  <- lme(fixed = Peat_Depth ~ VV_p5, data = Points, random = ~ 1 | dummy, method = "ML") 
#VH_p95.model  <- lme(fixed = Peat_Depth ~ VH_p95, data = Points, random = ~ 1 | dummy, method = "ML") 
#VH_p5.model  <- lme(fixed = Peat_Depth ~ VH_p5, data = Points, random = ~ 1 | dummy, method = "ML") 
S1.model  <- lme(fixed = Peat_Depth ~ Bodmin_S1_clipped, data = Points, random = ~ 1 | dummy, method = "ML") 
B1_S2_Sum.model  <- lme(fixed = Peat_Depth ~ Bodmin_S2_Sum_clipped_1, data = Points, random = ~ 1 | dummy, method = "ML") 
B2_S2_Sum.model  <- lme(fixed = Peat_Depth ~ Bodmin_S2_Sum_clipped_2, data = Points, random = ~ 1 | dummy, method = "ML") 
B3_S2_Sum.model  <- lme(fixed = Peat_Depth ~ Bodmin_S2_Sum_clipped_3, data = Points, random = ~ 1 | dummy, method = "ML") 
B4_S2_Sum.model  <- lme(fixed = Peat_Depth ~ Bodmin_S2_Sum_clipped_4, data = Points, random = ~ 1 | dummy, method = "ML") 
B5_S2_Sum.model  <- lme(fixed = Peat_Depth ~ Bodmin_S2_Sum_clipped_5, data = Points, random = ~ 1 | dummy, method = "ML") 
B6_S2_Sum.model <- lme(fixed = Peat_Depth ~ Bodmin_S2_Sum_clipped_6, data = Points, random = ~ 1 | dummy, method = "ML") 
B7_S2_Sum.model  <- lme(fixed = Peat_Depth ~ Bodmin_S2_Sum_clipped_7, data = Points, random = ~ 1 | dummy, method = "ML") 
B8_S2_Sum.model  <- lme(fixed = Peat_Depth ~ Bodmin_S2_Sum_clipped_8, data = Points, random = ~ 1 | dummy, method = "ML") 
B8A_S2_Sum.model  <- lme(fixed = Peat_Depth ~ Bodmin_S2_Sum_clipped_9, data = Points, random = ~ 1 | dummy, method = "ML") 
B9_S2_Sum.model  <- lme(fixed = Peat_Depth ~ Bodmin_S2_Sum_clipped_10, data = Points, random = ~ 1 | dummy, method = "ML") 
#B10_S2_Sum.model  <- lme(fixed = Peat_Depth ~ B10_S2_Sum, data = Points, random = ~ 1 | dummy, method = "ML") 
B11_S2_Sum.model  <- lme(fixed = Peat_Depth ~ Bodmin_S2_Sum_clipped_11, data = Points, random = ~ 1 | dummy, method = "ML") 
B12_S2_Sum.model  <- lme(fixed = Peat_Depth ~ Bodmin_S2_Sum_clipped_12, data = Points, random = ~ 1 | dummy, method = "ML") 
B1_S2_Win.model  <- lme(fixed = Peat_Depth ~ Bodmin_S2_Win_clipped_1, data = Points, random = ~ 1 | dummy, method = "ML") 
B2_S2_Win.model  <- lme(fixed = Peat_Depth ~ Bodmin_S2_Win_clipped_2, data = Points, random = ~ 1 | dummy, method = "ML") 
B3_S2_Win.model <- lme(fixed = Peat_Depth ~ Bodmin_S2_Win_clipped_3, data = Points, random = ~ 1 | dummy, method = "ML") 
B4_S2_Win.model  <- lme(fixed = Peat_Depth ~ Bodmin_S2_Win_clipped_4, data = Points, random = ~ 1 | dummy, method = "ML") 
B5_S2_Win.model  <- lme(fixed = Peat_Depth ~ Bodmin_S2_Win_clipped_5, data = Points, random = ~ 1 | dummy, method = "ML") 
B6_S2_Win.model  <- lme(fixed = Peat_Depth ~ Bodmin_S2_Win_clipped_6, data = Points, random = ~ 1 | dummy, method = "ML") 
B7_S2_Win.model  <- lme(fixed = Peat_Depth ~ Bodmin_S2_Win_clipped_7, data = Points, random = ~ 1 | dummy, method = "ML") 
B8_S2_Win.model  <- lme(fixed = Peat_Depth ~ Bodmin_S2_Win_clipped_8, data = Points, random = ~ 1 | dummy, method = "ML") 
B8A_S2_Win.model  <- lme(fixed = Peat_Depth ~ Bodmin_S2_Win_clipped_9, data = Points, random = ~ 1 | dummy, method = "ML") 
B9_S2_Win.model  <- lme(fixed = Peat_Depth ~ Bodmin_S2_Win_clipped_10, data = Points, random = ~ 1 | dummy, method = "ML") 
#B10_S2_Win.model  <- lme(fixed = Peat_Depth ~ B10_S2_Win, data = Points, random = ~ 1 | dummy, method = "ML") 
B11_S2_Win.model  <- lme(fixed = Peat_Depth ~ Bodmin_S2_Win_clipped_11, data = Points, random = ~ 1 | dummy, method = "ML") 
B12_S2_Win.model  <- lme(fixed = Peat_Depth ~ Bodmin_S2_Win_clipped_12, data = Points, random = ~ 1 | dummy, method = "ML") 
NDVI_Win.model <- lme(fixed = Peat_Depth ~ NDVI_Win_df, data = Points, random = ~ 1 | dummy, method = "ML") 
NDVI_Sum.model <- lme(fixed = Peat_Depth ~ NDVI_Sum_df, data = Points, random = ~ 1 | dummy, method = "ML") 
Dose.model <- lme(fixed = Peat_Depth ~ Dose, data = Points, random = ~ 1 | dummy, method = "ML") 
TotCount.model <- lme(fixed = Peat_Depth ~ TotCount, data = Points, random = ~ 1 | dummy, method = "ML") 
K.model <- lme(fixed = Peat_Depth ~ K, data = Points, random = ~ 1 | dummy, method = "ML") 
Ur.model <- lme(fixed = Peat_Depth ~ Ur, data = Points, random = ~ 1 | dummy, method = "ML") 
Th.model <- lme(fixed = Peat_Depth ~ Th, data = Points, random = ~ 1 | dummy, method = "ML") 
...
AICTable[1,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
AICTable[2,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
AICTable[3,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
AICTable[4,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
AICTable[5,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
AICTable[6,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
AICTable[7,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
AICTable[8,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
AICTable[9,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
#AICTable[10,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
#AICTable[11,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
#AICTable[12,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
#AICTable[13,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
AICTable[14,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
AICTable[15,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
AICTable[16,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
AICTable[17,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
AICTable[18,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
AICTable[19,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
AICTable[20,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
AICTable[21,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
AICTable[22,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
AICTable[23,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
#AICTable[24,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
AICTable[25,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
AICTable[26,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
AICTable[27,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
AICTable[28,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
AICTable[29,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
AICTable[30,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
AICTable[31,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
AICTable[32,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
AICTable[33,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
AICTable[34,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
AICTable[35,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
AICTable[36,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
#AICTable[37,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
AICTable[38,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
AICTable[39,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
AICTable[40,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
AICTable[41,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
AICTable[42,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
AICTable[43,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
AICTable[44,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
AICTable[45,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
...
AICTable[46,3] <- sqrt(mean((a$data$Peat_Depth - a$fitted[,1])^2))
b<-MuMIn::r.squaredGLMM(Th.model)
AICTable[46,4] <- b[1]
c<- anova(Th.model)
AICTable[46,5] <-c$`p-value`[2]

save(AICTable, file = "C:/LocalData/sp991/GEOM184/CodeForMSc/Final/Inputs/AICTableLinearSingle.RData")
