...
B4_S2_Win<- ggplot(data = Points, aes(x =B4_S2_Win, y = Peat_DepthL)) +
  geom_point(colour = "gray30") +
  geom_smooth(method = "lm", se = FALSE) +
...
NDVI_Win<- ggplot(data = Points, aes(x =NDVI_Win, y = Peat_DepthL)) +
  geom_point(colour = "gray30") +
  geom_smooth(method = "lm", se = FALSE) +
  labs(x = "Winter NDVI",
       y = "Ln(Peat Depth +1) (Ln(cm))")+
...
B5_S2_Win<- ggplot(data = Points, aes(x =B5_S2_Win, y = Peat_DepthL)) +
  geom_point(colour = "gray30") +
  geom_smooth(method = "lm", se = FALSE) +
...
DSM<- ggplot(data = Points, aes(x =DSM, y = Peat_DepthL)) +
  geom_point(colour = "gray30") +
  geom_smooth(method = "lm", se = FALSE) +
  labs(x = "Elevation (m)",
       y = "Ln(Peat Depth +1) (Ln(cm))")+
...
TWI<- ggplot(data = Points, aes(x =TWI, y = Peat_DepthL)) +
  geom_point(colour = "gray30") +
  geom_smooth(method = "lm", se = FALSE) +
  labs(x = "TWI",
       y = "Ln(Peat Depth +1) (Ln(cm))")+
...
VV_p5<- ggplot(data = Points, aes(x =VV_p5, y = Peat_DepthL)) +
  geom_point(colour = "gray30") +
  geom_smooth(method = "lm", se = FALSE) +
  labs(x = "S1 VV Q5",
       y = "Ln(Peat Depth +1) (Ln(cm))")+
