...
DSM.model <- lme(fixed = Peat_Depth ~ DSM, data = Points, random = ~ 1 | dummy, method = "ML") 
...
TWI.model <- lme(fixed = Peat_Depth ~ TWI, data = Points, random = ~ 1 | dummy, method = "ML") 
...
B1_S2_Sum.model  <- lme(fixed = Peat_Depth ~ B1_S2_Sum, data = Points, random = ~ 1 | dummy, method = "ML") 
B2_S2_Sum.model  <- lme(fixed = Peat_Depth ~ B2_S2_Sum, data = Points, random = ~ 1 | dummy, method = "ML") 
B3_S2_Sum.model  <- lme(fixed = Peat_Depth ~ B3_S2_Sum, data = Points, random = ~ 1 | dummy, method = "ML") 
B4_S2_Sum.model  <- lme(fixed = Peat_Depth ~ B4_S2_Sum, data = Points, random = ~ 1 | dummy, method = "ML") 
B5_S2_Sum.model  <- lme(fixed = Peat_Depth ~ B5_S2_Sum, data = Points, random = ~ 1 | dummy, method = "ML") 
B6_S2_Sum.model <- lme(fixed = Peat_Depth ~ B6_S2_Sum, data = Points, random = ~ 1 | dummy, method = "ML") 
B7_S2_Sum.model  <- lme(fixed = Peat_Depth ~ B7_S2_Sum, data = Points, random = ~ 1 | dummy, method = "ML") 
B8_S2_Sum.model  <- lme(fixed = Peat_Depth ~ B8_S2_Sum, data = Points, random = ~ 1 | dummy, method = "ML") 
B8A_S2_Sum.model  <- lme(fixed = Peat_Depth ~ B8A_S2_Sum, data = Points, random = ~ 1 | dummy, method = "ML") 
B9_S2_Sum.model  <- lme(fixed = Peat_Depth ~ B9_S2_Sum, data = Points, random = ~ 1 | dummy, method = "ML") 
B10_S2_Sum.model  <- lme(fixed = Peat_Depth ~ B10_S2_Sum, data = Points, random = ~ 1 | dummy, method = "ML") 
B11_S2_Sum.model  <- lme(fixed = Peat_Depth ~ B11_S2_Sum, data = Points, random = ~ 1 | dummy, method = "ML") 
B12_S2_Sum.model  <- lme(fixed = Peat_Depth ~ B12_S2_Sum, data = Points, random = ~ 1 | dummy, method = "ML") 
B1_S2_Win.model  <- lme(fixed = Peat_Depth ~ B1_S2_Win, data = Points, random = ~ 1 | dummy, method = "ML") 
B2_S2_Win.model  <- lme(fixed = Peat_Depth ~ B2_S2_Win, data = Points, random = ~ 1 | dummy, method = "ML") 
B3_S2_Win.model <- lme(fixed = Peat_Depth ~ B3_S2_Win, data = Points, random = ~ 1 | dummy, method = "ML") 
B4_S2_Win.model  <- lme(fixed = Peat_Depth ~ B4_S2_Win, data = Points, random = ~ 1 | dummy, method = "ML") 
B5_S2_Win.model  <- lme(fixed = Peat_Depth ~ B5_S2_Win, data = Points, random = ~ 1 | dummy, method = "ML") 
B6_S2_Win.model  <- lme(fixed = Peat_Depth ~ B6_S2_Win, data = Points, random = ~ 1 | dummy, method = "ML") 
B7_S2_Win.model  <- lme(fixed = Peat_Depth ~ B7_S2_Win, data = Points, random = ~ 1 | dummy, method = "ML") 
B8_S2_Win.model  <- lme(fixed = Peat_Depth ~ B8_S2_Win, data = Points, random = ~ 1 | dummy, method = "ML") 
B8A_S2_Win.model  <- lme(fixed = Peat_Depth ~ B8A_S2_Win, data = Points, random = ~ 1 | dummy, method = "ML") 
B9_S2_Win.model  <- lme(fixed = Peat_Depth ~ B9_S2_Win, data = Points, random = ~ 1 | dummy, method = "ML") 
B10_S2_Win.model  <- lme(fixed = Peat_Depth ~ B10_S2_Win, data = Points, random = ~ 1 | dummy, method = "ML") 
B11_S2_Win.model  <- lme(fixed = Peat_Depth ~ B11_S2_Win, data = Points, random = ~ 1 | dummy, method = "ML") 
B12_S2_Win.model  <- lme(fixed = Peat_Depth ~ B12_S2_Win, data = Points, random = ~ 1 | dummy, method = "ML") 
NDVI_Win.model <- lme(fixed = Peat_Depth ~ NDVI_Win, data = Points, random = ~ 1 | dummy, method = "ML") 
NDVI_Sum.model <- lme(fixed = Peat_Depth ~ NDVI_Sum, data = Points, random = ~ 1 | dummy, method = "ML") 
...
save(AICTable, file = "C:/Users/ng292/OneDrive - University of Exeter/NfCPGS/PeatMapping/AICTableLinearSingle.RData")
